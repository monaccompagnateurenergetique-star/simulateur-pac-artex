...
import { UserPlus, Save, ArrowLeft, MapPin, Check, AlertTriangle, Thermometer, Search, Loader2, ChevronDown, ChevronUp, X } from 'lucide-react'
            ...
            {showDpeResults && dpeResults && dpeResults.length > 0 && (
              <div className="border border-indigo-200 rounded-lg overflow-hidden">
                <div className="bg-indigo-50 px-4 py-2 border-b border-indigo-200">
                  <p className="text-xs font-semibold text-indigo-700">{dpeResults.length} diagnostic{dpeResults.length > 1 ? 's' : ''} trouvé{dpeResults.length > 1 ? 's' : ''}</p>
                </div>
