...
export default function LeadFormPage() {
  ...
  function handleSelectDPE(dpe) {
    setSelectedDpe({
      ...
      surface: dpe.surface,
      surfaceImmeuble: dpe.surfaceImmeuble,
      typeBatiment: dpe.typeBatiment,
      nombreAppartements: dpe.nombreAppartements,
      nombreNiveaux: dpe.nombreNiveaux,
      consoM2: dpe.consoM2,
      emissionGes: dpe.emissionGes,
      coutTotal: dpe.coutTotal,
      coutChauffage: dpe.coutChauffage,
      installationChauffage: dpe.installationChauffage,
      energieChauffage: dpe.energieChauffage,
      generateurChauffage: dpe.generateurChauffage,
      installationEcs: dpe.installationEcs,
      energieEcs: dpe.energieEcs,
      typeVentilation: dpe.typeVentilation,
      isolationEnveloppe: dpe.isolationEnveloppe,
      isolationMurs: dpe.isolationMurs,
      isolationPlancherBas: dpe.isolationPlancherBas,
