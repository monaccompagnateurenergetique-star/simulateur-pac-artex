  ...
  INSULATION_CATEGORIES: [
    {
      ...
      levels: [
        { value: 'aucune',    label: 'Aucune',           ratio: 1.5 },
        { value: 'faible',    label: 'Faible',           ratio: 1.2 },
        { value: 'moyenne',   label: 'Moyenne',          ratio: 1.0 },
        { value: 'forte',     label: 'Forte',            ratio: 0.7 },
        { value: 'tres_perf', label: 'Très performante', ratio: 0.5 },
      ],
    },
    {
      key: 'murs',
      ...
      defaultValue: 'moyenne',
      levels: [
        { value: 'non',         label: 'Non isolé',  ratio: 1.5 },
        { value: 'faible',      label: 'Faible',     ratio: 1.2 },
        { value: 'moyenne',     label: 'Moyenne',    ratio: 1.0 },
        { value: 'forte',       label: 'Forte',      ratio: 0.7 },
        { value: 'tres_forte',  label: 'Très forte', ratio: 0.5 },
      ],
    },
    {
      key: 'plancher',
      ...
      levels: [
        { value: 'aucune',     label: 'Aucune',     ratio: 1.5 },
        { value: 'mauvaise',   label: 'Mauvaise',   ratio: 1.2 },
        { value: 'bonne',      label: 'Bonne',      ratio: 1.0 },
        { value: 'tres_bonne', label: 'Très bonne', ratio: 0.7 },
      ],
    },
    {
      key: 'fenetres',
      ...
      levels: [
        { value: 'simple',         label: 'Simple vitrage',   ratio: 1.8 },
        { value: 'double_ancien',  label: 'Double (ancien)',  ratio: 1.2 },
        { value: 'double_recent',  label: 'Double (récent)',  ratio: 1.0 },
        { value: 'triple',         label: 'Triple vitrage',   ratio: 0.7 },
      ],
    },
    {
      key: 'portes',
      ...
      defaultValue: 'isole',
      levels: [
        { value: 'ancien', label: 'Ancien', ratio: 1.3 },
        { value: 'isole',  label: 'Isolé',  ratio: 1.0 },
      ],
    },
    {
      key: 'ponts',
      ...
      levels: [
        { value: 'ancien',     label: 'Ancien',     ratio: 1.3 },
        { value: 'moyen',      label: 'Moyen',      ratio: 1.1 },
        { value: 'recent',     label: 'Récent',     ratio: 1.0 },
        { value: 'performant', label: 'Performant', ratio: 0.8 },
      ],
    },
    {
      key: 'ventilation',
      ...
      levels: [
        { value: 'naturelle',   label: 'Naturelle',      ratio: 1.3 },
        { value: 'simple_flux', label: 'Simple flux',    ratio: 1.1 },
        { value: 'hydro',       label: 'Hydro-réglable', ratio: 1.0 },
        { value: 'double_flux', label: 'Double flux',    ratio: 0.7 },
      ],
    },
  ],
